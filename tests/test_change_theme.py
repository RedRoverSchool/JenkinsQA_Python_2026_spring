...
def test_quick_change_theme_not_able(browser):
    ...
    home_page.show_dropdown_menu_from_profile_icon()
    home_page.dropdown_menu_appearance_click()
    home_page.show_dropdown_menu_from_profile_icon()

    elements = home_page.find_element_dropdown_menu_from_profile_icon()
    assert not elements, "Error: Quick theme change block is displayed, when the Appearance page is open"
